...
| 3:00        | Questions and introduction to the exercise: <br> [Introduction to R](https://github.com/AlexsLemonade/training-modules/blob/{{site.release_tag}}/intro-to-R-tidyverse/01b-intro_to_base_R_exercise.Rmd) | Zoom: Breakout Rooms |
...
| 3:00        | Questions and introduction to the exercise: <br> [Exploratory Data Analysis](https://github.com/AlexsLemonade/training-modules/blob/{{site.release_tag}}RNA-seq/03b-exploratory_data_analysis_exercise.Rmd) | Zoom: Breakout Rooms |
| 3:30        | [Consultation session](workshop-structure.md#consultation-sessions) begins |   `#2020-june-training` Slack channel
| 5:00        | End             |        
...
| 3:00        | Questions and introduction to the exercise: <br> [Bulk RNA-seq Exercise](https://github.com/AlexsLemonade/training-modules/blob/{{site.release_tag}}/RNA-seq/06-bulk_rnaseq_exercise.Rmd) | Zoom Breakout Rooms |
| 3:30        | [Consultation session](workshop-structure.md#consultation-sessions) begins |   `#2020-june-training` Slack channel
| 5:00        | End             |
